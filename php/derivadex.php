...
class derivadex extends Exchange {
    ...
    public function fetch_markets($params = array ()) {
         ...
         */
        $params['kind'] = 0;
        $response = $this->publicGetSpecs ($params);
        // {
        //     "value" => array(
        //         {
        //             "kind" => 0,
    ...
    public function fetch_ticker($symbol, $params = array ()) {
        ...
        $tickers = $this->fetch_tickers([ $market['id'] ], $params);
    ...
    public function fetch_tickers($symbols = null, $params = array ()) {
        ...
        for ($i = 0; $i < count($symbols); $i++) {
            $ticker = $this->construct_ticker($symbols[$i]);
            if ($ticker !== null) {
    ...
    public function fetch_my_trades($symbol = null, $since = null, $limit = null, $params = array ()) {
        ...
        $response = $this->publicGetFills ($extendedRequest);
        $traderAddressWithDiscriminant = $this->add_discriminant($this->walletAddress);
        $mainStrategyIdHash = $this->get_main_strategy_id_hash();
        return $this->parse_trades_custom($response, $market, $since, $limit, $traderAddressWithDiscriminant, $mainStrategyIdHash);
    }
    ...
    public function fetch_trades($symbol, $since = null, $limit = null, $params = array ()) {
        ...
        $request['order'] = $params['order'] !== null ? $params['order'] : 'asc';
        $response = $this->publicGetFills (array_merge($request, $params));
        // {
        //     value => array(
        //       array(
        //         epochId => '27',
        ...
        //     )
        // }
        return $this->parse_trades_custom($response, $market, $since, $limit);
    }
    ...
    public function get_order_intents($trades) {
        ...
        $orderIntentResponse = $this->publicGetOrderIntents ($params);
    ...
    public function parse_trades_custom($trades, $market = null, $since = null, $limit = null, $trader = null, $strategy = null) {
        ...
        $result = array();
        $orderIntents = $this->get_order_intents($trades[0]);
    ...
    public function fetch_ohlcv($symbol, $timeframe = '1m', $since = null, $limit = null, $params = array ()) {
        ...
        $response = $this->v2GetRestOhlcv (array_merge($request, $params));
    ...
    public function get_sequenced_order($operatorResponse, $lookbackLimit = null) {
        ...
        $response = $this->publicGetAccountTraderStrategyStrategyIdOrderIntents ($params);
        $order = $response['value'].find ((intent) => intent.nonce === $operatorResponse->c.nonce);
        if ($order === null) {
            $this->wait(1000); // retry after 1 second
            $response = $this->publicGetAccountTraderStrategyStrategyIdOrderIntents ($params);
            $order = $response['value'].find ((intent) => intent.nonce === $operatorResponse->c.nonce);
            if ($order === null) {
    ...
    public function fetch_public_orders($symbol = null, $since = null, $limit = null, $params = array ()) {
        ...
        $request['order'] = $params['order'] !== null ? $params['order'] : 'asc';
        $response = $this->publicGetOrderIntents ($request);
        return $this->parse_orders_custom($response['value'], $market, $since, $limit);
    }
    ...
    public function fetch_order($id, $symbol = null, $params = array ()) {
        ...
        $response = $this->publicGetOrderIntents ($request);
        return $this->parse_order($response['value'][0], $market);
    }
    ...
    public function fetch_orders($symbol = null, $since = null, $limit = null, $params = array ()) {
        ...
        $request['order'] = $params['order'] !== null ? $params['order'] : 'asc';
        $response = $this->publicGetAccountTraderStrategyStrategyIdOrderIntents ($request);
        return $this->parse_orders_custom($response['value'], $market, $since, $limit);
    }
    ...
    public function parse_order($order, $market = null) {
        ...
        $fillResponse = $this->publicGetFills ($params);
    ...
    public function update_profile($payFeesInDDX) {
        ...
        $operatorResponse = $this->get_operator_response_for_order_intent($orderIntent, 'ProfileUpdate');
    ...
    public function cancel_all_orders($symbol = null, $params = array ()) {
        ...
        $operatorResponse = $this->get_operator_response_for_order_intent($orderIntent, 'CancelAll');
        if ($operatorResponse['t'] !== 'Sequenced') {
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) {
        ...
        $operatorResponse = $this->get_operator_response_for_order_intent($orderIntent, 'CancelOrder');
        $timestamp = Date.now ();
        if ($operatorResponse['t'] !== 'Sequenced') {
    ...
    public function create_order($symbol, $type, $side, $amount, $price = null, $params = array ()) {
        ...
        $operatorResponse = $this->get_operator_response_for_order_intent($orderIntent, 'Order');
        if ($operatorResponse['t'] !== 'Sequenced') {
        ...
        return $this->get_sequenced_order($operatorResponse, 10);
    }
    ...
    public function get_operator_response_for_order_intent($orderIntent, $requestType) {
        ...
        if ($encryptionKey === null) {
            $encryptionKey = $this->v2GetEncryptionKey ();
        ...
        $encryptedIntent = $this->encrypt_intent($encryptionKey, $intent);
        $buffer = Buffer.from (str_replace(/^0x/, '', $encryptedIntent), 'hex');
        return $this->v2PostRequest ($buffer);
    }
    ...
    public function fetch_balance($params = array ()) {
        ...
        $strategyResponse = $this->publicGetAccountTraderStrategyStrategyId ($strategyRequest);
        // {
        //     value => array(
    ...
    public function fetch_deposit_address($code, $params = array ()) {
         ...
         */
        $addresses = $this->rawGetSnapshotAddresses (array( 'contractDeployment' => 'beta' )); // TODO => switch to mainnet
    ...
    public function fetch_positions($symbols = null, $params = array ()) {
         ...
         */
        $response = $this->publicGetPositions ();
    ...
    public function fetch_funding_rate($symbol, $params = array ()) {
         ...
         */
        $response = $this->publicGetMarkets (array( 'symbol' => $symbol ));
        $response['value'].forEach ((rate) => array(
            rate.timestamp = $response['timestamp'] * 1000;
        ));
